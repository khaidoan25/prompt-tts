...
if __name__ == "__main__":
    ...
    sample = torch.rand(2, block_out_channels[0], 1500)
    condition = torch.rand(2, 50, 768)
    
    output = attn(sample, condition, timesteps)
    
    print(output.sample.size())
